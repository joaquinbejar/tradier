...
### Commit convention and changelog

This project uses [Conventional Commits](https://www.conventionalcommits.org)
(`feat:`, `fix:`, `docs:`, `refactor:`, `perf:`, `test:`, `ci:`, `build:`,
`chore:`). The `CHANGELOG.md` is generated by
[git-cliff](https://git-cliff.org) from the commit history.

On each release tag (`vX.Y.Z`), a GitHub Actions workflow
(`.github/workflows/changelog.yml`) regenerates `CHANGELOG.md` and
pushes the update to `main`. You can preview what the next entry will
look like locally:
